...
namespace RetailBankManagement
{
    public partial class withdraw : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Label18.Text = "Withdraw not allowed, please choose smaller amount";
            }
            else
            {
                try
                {
                    ...
                    Label18.Text = "Amount withdrawn successfully";
                }
                catch (Exception ex)
                {
                    Label18.Text = "Failed to Withdraw" + ex.Message;
                }
